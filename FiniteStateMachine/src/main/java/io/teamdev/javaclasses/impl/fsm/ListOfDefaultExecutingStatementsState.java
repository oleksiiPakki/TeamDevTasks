...
public class ListOfDefaultExecutingStatementsState extends State<SwitchStructure> {
    private final boolean mayBeFinish;
    private final boolean isLexeme;

    public ListOfDefaultExecutingStatementsState(boolean mayBeFinish, boolean isLexeme) {
